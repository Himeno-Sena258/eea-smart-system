...
public class AdminOrgController {
    ...
    @GetMapping("/tree")
    @Operation(summary = "【组织架构】获取全校组织架构树", description = "返回 学院 -> 专业 -> 行政班级 的树状结构数据")
    ...
    @PostMapping
    @Operation(summary = "【组织架构】创建组织机构 / 专业 / 行政班")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "【组织架构】修改组织机构名称")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "【组织架构】删除组织机构", description = "删前校验子节点与关联用户，防止破坏层级")
