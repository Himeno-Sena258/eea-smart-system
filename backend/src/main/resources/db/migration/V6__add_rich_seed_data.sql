...
-- 10. 课程目标表 (course_objective) - 匹配列名: id, course_id, objective_code, content
...
-- 11. OBE 矩阵映射表 (course_obj_indicator_map) - 匹配列名: id, course_objective_id, indicator_point_id, weight
